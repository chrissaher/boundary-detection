...
def main():
    ...
    for filename in files:
        ...
        output_path = os.path.join('output', filename.split('.')[0] + "_left.mp4")
        ...
        net_left = torch.load('./models/160x60/model_epoch_450.ckpt')
        net_right = torch.load('./models/160x60_right/model_epoch_450.ckpt')
        ...
        for i in tqdm(range(nb_frames)):
            ...
            image = cv2.resize(image, (160, 60)).transpose(2,0,1)
